...
export const RAIDS = [
  ...
  // ── Hardcore ──────────────────────────────────────────────────────────────
  // Acte 1 HC
  { id: 100, slug: 'mother-cuby-hc',          icon: '1127', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 30,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Mère Cuby HC',                    en: 'Mother Cuby HC',                 de: 'Cuby Mutter HC' },
  { id: 101, slug: 'ginseng-hc',              icon: '1128', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 40,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Ginseng HC',                      en: 'Ginseng HC',                     de: 'Ginseng HC' },
  { id: 102, slug: 'dark-castra-hc',          icon: '1129', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 50,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Castra obscur HC',                en: 'Dark Castra HC',                 de: 'Dark Castra HC' },
  { id: 103, slug: 'giant-black-spider-hc',   icon: '1130', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 60,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Araignée noire géante HC',        en: 'Giant Black Spider HC',          de: 'Schwarze Riesenspinne HC' },
  { id: 104, slug: 'massive-slade-hc',        icon: '1131', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 70,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Slade géant HC',                  en: 'Massive Slade HC',               de: 'Riesenslade HC' },
  // Acte 5 HC
  { id: 109, slug: 'ibrahim-hc',              icon: '1892', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 80,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Ibrahim HC',                      en: 'Ibrahim HC',                     de: 'Ibrahim HC' },
  { id: 113, slug: 'kertos-hc',               icon: '2460', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 85,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Kertos, le chien-démon HC',       en: 'Kertos the Demon Dog HC',        de: 'Kertos, der Dämonenhund HC' },
  { id: 114, slug: 'valakus-hc',              icon: '2461', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 85,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Valakus, roi des flammes HC',     en: 'Valakus King of Fire HC',        de: 'Feuerkönig Valakus HC' },
  { id: 115, slug: 'grenigas-hc',            icon: '2462', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 85,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Grenigas, le dieu du Feu HC',     en: 'Fire God Grenigas HC',           de: 'Feuergott Grenigas HC' },
  { id: 116, slug: 'lord-draco-hc',           icon: '2547', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 75,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Sire Draco HC',                   en: 'Lord Draco HC',                  de: 'Lord Draco HC' },
  { id: 117, slug: 'glacerus-hc',            icon: '2583', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 80,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Glacerus le Rude HC',             en: 'Glacerus the Ice Cold HC',       de: 'Glacerus, der Eiskalte HC' },
  { id: 127, slug: 'twisted-yertirand-hc',    icon: '2942', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 70,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Yertirand corrompu HC',           en: 'Twisted Yertirand HC',           de: 'Verdorbener Yertirand HC' },
  // Acte 6 HC
  { id: 123, slug: 'zenas-hc',                icon: '2750', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 90,  maxPlayers: 20, dailyLimit: 5, hc: true,
    fr: 'Zénas HC',                        en: 'Zenas HC',                       de: 'Zenas HC' },
  { id: 124, slug: 'erenia-hc',               icon: '2751', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 90,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Erenia HC',                       en: 'Erenia HC',                      de: 'Erenia HC' },
  { id: 125, slug: 'incomplete-fernon-hc',    icon: '2868', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 92,  maxPlayers: 8,  dailyLimit: 5, hc: true,
    fr: 'Fernon incomplète HC',            en: 'Incomplete Fernon HC',           de: 'Unvollendete Fernon HC' },
  { id: 126, slug: 'greedy-fafnir-hc',        icon: '2905', act: 'hardcore', color: '#ff4757', cooldown: 48, minLevel: 70,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Terrible Fafnir HC',              en: 'Greedy Fafnir HC',               de: 'Gieriger Fafnir HC' },
  // Acte 7 HC
  { id: 130, slug: 'spirit-king-kirollas-hc', icon: '4271', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 90,  maxPlayers: 8,  dailyLimit: 5, hc: true,
    fr: 'Kirollas roi des esprits HC',     en: 'Spirit King Kirollas HC',        de: 'Geisterkönig Kirollas HC' },
  { id: 131, slug: 'beast-king-carno-hc',     icon: '4272', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 90,  maxPlayers: 8,  dailyLimit: 5, hc: true,
    fr: 'Carno roi des bêtes HC',          en: 'Beast King Carno HC',            de: 'Bestienkönig Carno HC' },
  { id: 132, slug: 'demon-god-belial-hc',     icon: '4273', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 90,  maxPlayers: 20, dailyLimit: 5, hc: true,
    fr: 'Dieu-démon Bélial HC',            en: 'Demon God Belial HC',            de: 'Dämonengott Belial HC' },
  { id: 133, slug: 'evil-overlord-paimon-hc', icon: '4304', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 20,  maxPlayers: 20, dailyLimit: 5, hc: true,
    fr: 'Paimon, seigneur maléfique HC',   en: 'Evil Overlord Paimon HC',        de: 'Böser Gebieter Paimon HC' },
  { id: 134, slug: 'revenant-paimon-hc',      icon: '4500', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 10,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Paimon ressuscité HC',            en: 'Revenant Paimon HC',             de: 'Auferstandener Paimon HC' },
  // Acte 8 HC
  { id: 135, slug: 'zombie-dragon-valehir-hc',icon: '4612', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 20,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Dragon zombie Valehir HC',        en: 'Zombie Dragon Valehir HC',       de: 'Zombiedrache Valehir HC' },
  { id: 136, slug: 'ice-dragon-alzanor-hc',   icon: '4615', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 20,  maxPlayers: 15, dailyLimit: 5, hc: true,
    fr: 'Alzanor dragon givré HC',         en: 'Ice Dragon Alzanor HC',          de: 'Eisdrache Alzanor HC' },
  { id: 138, slug: 'weak-asgobas-hc',         icon: '4868', act: 'hardcore', color: '#ff4757', cooldown: 24, minLevel: 30,  maxPlayers: 15, dailyLimit: 5, hc: true,
